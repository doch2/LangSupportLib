...
public class Reference {
    public static String prefix_normal = "§6[EtereunaCrafting] §r";
    public static String prefix_opMessage = "§b[EtereunaCrafting-OP메세지] §r";
    public static String prefix_error = "§c§l[EtereunaCrafting] §7";
